...
public class HeatmapNew
{
	...
	{TYPE_A, TYPE_B, XP_GAINED, TELEPORT_PATHS, TELEPORTED_TO, TELEPORTED_FROM, LOOT_VALUE, PLACES_SPOKEN_AT, RANDOM_EVENT_SPAWNS, DEATHS, BOB_THE_CAT_SIGHTING, MELEE_FIGHTING, RANGED_FIGHTING, MAGE_FIGHTING, DRAGON_IMPLING_CATCHES, UNKNOWN}
	@Getter @Setter
